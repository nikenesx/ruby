...
employe1.birthDate = "1.1.21"
puts employe1.birthDate #=> 01.01.2021

employe2.birthDate = "32.01.1999" #=> Неверный формат даты
puts employe2.birthDate #=> 06.11.1988

employe3 = TestEmploye.new
employe3.birthDate = "30.10.1900" #=> Неверный формат даты
p employe3.birthDate #=> nil